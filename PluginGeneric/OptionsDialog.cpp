...
#elif __IDP__
#include "..\ScyllaHideIDAProPlugin\IdaConfig.h"
...
void UpdateOptions(HWND hWnd)
{
    ...
    EnableWindow(GetDlgItem(hWnd, IDC_AUTOSTARTSERVER), TRUE);
...
#elif __IDP__
			char newProfile[100] = {0};
            int result = ask_form("Enter new profile name\n <New Profile Name:A:15:15::>\n", newProfile);
            if(result == 1) {
                mbstowcs(newProfileW, newProfile, MAX_SECTION_NAME);
