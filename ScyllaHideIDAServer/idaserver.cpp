...
#include "..\PluginGeneric\Global.h"
...
COMPILE_TIME_ASSERT(sizeof(IDA_SERVER_EXCHANGE) == IDA_SERVER_EXCHANGE_STRUCT_SIZE);
			...
			case dbg_process_start:
				{
					...
					printf("Received event 'dbg_process_start' with PID: %X (%d)\n", ProcessId, ProcessId);
					...
					{
						bHooked = true;
						printf("Starting initial injection with file %S\n", ScyllaHideDllPath);
